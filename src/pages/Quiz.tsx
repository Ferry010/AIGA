...
const questions = [
  {
    q: "Hoeveel medewerkers in jouw organisatie gebruiken AI-tools zoals ChatGPT, Copilot of vergelijkbare software?",
    options: ["Niemand, voor zover ik weet", "Een handvol early adopters", "Een significant deel van de teams", "De meeste medewerkers, dagelijks"],
  },
  {
    q: "Heeft jouw organisatie een beleid of richtlijn voor verantwoord AI-gebruik?",
    options: ["Nee, dat bestaat niet bij ons", "Er zijn informele afspraken maar niets op papier", "We hebben iets, maar het is niet actueel", "Ja, een formeel beleid dat actief wordt gebruikt"],
  },
  {
    q: "Weten jouw medewerkers wat de EU AI Act inhoudt en wat die van hen vraagt?",
    options: ["Nee, de meesten hebben er nog nooit van gehoord", "Enkelen hebben erover gelezen maar er is geen bewustzijn", "Het management weet het, de werkvloer nog niet", "Ja, er is breed bewustzijn en we zijn al bezig met compliance"],
  },
  {
    q: "Heeft jouw organisatie documentatie die bewijst dat medewerkers AI-geletterd zijn?",
    options: ["Nee, niets", "We hebben wat notities maar niets formeel", "Er zijn trainingen gevolgd maar geen formeel certificaat", "Ja, medewerkers zijn gecertificeerd via een erkend programma"],
  },
  {
    q: "Hoe worden AI-gerelateerde risico's (bias, datamisbruik, privacy) momenteel beheerd?",
    options: ["Dat wordt niet actief beheerd", "Incidenteel, als er iets misgaat", "Er zijn richtlijnen maar geen actieve monitoring", "Er is een actief risicobeheer met duidelijke verantwoordelijken"],
  },
  {
    q: "Zijn leidinggevenden in staat om AI-gebruik van hun team te beoordelen en te sturen?",
    options: ["Nee, ze weten zelf ook weinig van AI", "Ze begrijpen de basis maar missen diepgang", "De meesten wel, maar het is inconsistent", "Ja, leidinggevenden hebben voldoende kennis en kaders"],
  },
  {
    q: "Hoe urgent is AI Act-compliance voor jouw organisatie op dit moment?",
    options: ["We hebben er nog niet serieus over nagedacht", "We weten dat het moet maar hebben geen plan", "We zijn er mee bezig maar lopen achter", "We zijn goed op weg en hebben een duidelijk plan"],
  },
  {
    q: "Heeft jouw organisatie een AI-verantwoordelijke of intern aanspreekpunt voor AI-beleid?",
    options: ["Nee", "Iemand doet het erbij maar het is niet officieel", "Er is iemand aangewezen maar zonder budget of mandaat", "Ja, er is een dedicated verantwoordelijke met mandaat"],
  },
  {
    q: "Hoe worden nieuwe medewerkers geintroduceerd op het gebied van AI-gebruik en AI-risico's?",
    options: ["Dat gebeurt niet", "Via informele kennisoverdracht van collega's", "Er is een onboarding module maar die is niet up-to-date", "Via een formeel en actueel AI-onboardingprogramma"],
  },
  {
    q: "Stel: er is morgen een audit op AI-geletterdheid. Hoe sta je ervoor?",
    options: ["Slecht. We kunnen niets aantonen.", "Matig. We hebben wel iets maar het is niet overtuigend.", "Redelijk. We zijn bezig maar nog niet compliant.", "Goed. We kunnen aantonen dat ons team gecertificeerd is."],
  },
];
...
const Quiz = () => {
  ...
  if (phase === "intro") {
    return (
      <div className="min-h-screen flex items-center justify-center dot-grid-bg">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <AnimatedSection>
            ...
            <button
              ...
              className="mt-8 bg-primary text-primary-foreground px-8 py-4 rounded-md font-semibold text-[15px] hover:brightness-110 hover:-translate-y-px transition-all"
            >
              Start de check
            </button>
          </AnimatedSection>
              ...
              {q.options.map((opt, i) => (
                <button
                  ...
                  className={`w-full text-left p-4 rounded-xl border transition-all text-sm leading-relaxed ${
                    selected === i
                      ? "border-primary bg-brand-dim text-foreground"
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-32">
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className="max-w-2xl w-full text-center">
        ...
        <span
          className="inline-block text-[11px] font-bold uppercase tracking-[0.12em] px-3 py-1 rounded-full mb-4"
        ...
        <div className="mt-8 bg-brand-dim border border-primary/20 rounded-xl p-6 text-left">
        ...
        <div className="flex flex-wrap justify-center gap-3 mt-8">
          {tier.ctas.map((c) => (
            <Link key={c.label} to={c.to} className="bg-primary text-primary-foreground px-6 py-3 rounded-md font-semibold text-sm hover:brightness-110 transition-all">
              {c.label}
            </Link>
          ))}
        </div>

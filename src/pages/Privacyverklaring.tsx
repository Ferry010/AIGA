...
const Privacyverklaring = () => (
  <>
    <SEO
      ...
      description="Lees hoe AI Geletterdheid Academy omgaat met je persoonsgegevens, welke gegevens wij verzamelen en welke rechten jij hebt."
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <article className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p>
          ...
          <Link to="/contact" className="text-primary hover:underline">contactformulier</Link> op de website.
        </p>
        ...
        <p>
          ...
          <Link to="/contact" className="text-primary hover:underline">contactformulier</Link> op de website. Wij reageren binnen 30 dagen.
        </p>
        <p>

...
const WAT_IS_FAQ = [
  ...
  { q: "Is AI-geletterdheid wettelijk verplicht?", a: "Ja. Artikel 4 van de EU AI Act, die op 2 februari 2025 van kracht werd, verplicht alle aanbieders en gebruiksverantwoordelijken van AI-systemen om te zorgen voor een toereikend niveau van AI-geletterdheid bij hun personeel. Actieve handhaving door de Autoriteit Persoonsgegevens start per augustus 2026. Boetes kunnen oplopen tot 35 miljoen euro of 7% van de jaaromzet." },

import { Mail, Download, Check, AlertTriangle, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        description="De volledige EU AI Act samengevat op 1 A4. Tijdlijn, risicocategorieën, verplichtingen en boetes — printbaar en deelbaar."
        canonical="/kenniscentrum/eu-ai-act-in-1-a4"
      />
      <BreadcrumbNav
        items={[
          { label: "Home", href: "/" },
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 print:p-0 print:max-w-none">
        <div
          id="a4-document"
          className="bg-white border border-border shadow-sm mx-auto print:border-none print:shadow-none print:mx-0"
          style={{ maxWidth: "794px", aspectRatio: "1/1.414" }}
        >
          <div className="p-6 sm:p-8 flex flex-col h-full text-foreground" style={{ fontSize: "12px", lineHeight: "1.5" }}>
            {/* ── Header ── */}
            ...
            <div className="mb-3">
              ...
              <div className="grid grid-cols-2 gap-3 mt-1">
                <div>
                  <p className="font-bold text-[10px] mb-1">Voor aanbieders (providers):</p>

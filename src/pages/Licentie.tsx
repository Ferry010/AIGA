...
const Licentie = () => (
  <>
    <SEO
      ...
      description="Lees de licentie- en gebruiksvoorwaarden van AI Geletterdheid Academy (AIGA). Informatie over eigendom, gebruik en certificering."
      canonical="/licentie"
    />
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <article className="prose prose-neutral max-w-none dark:prose-invert">
        ...
        <p>
          ...
          <Link to="/contact" className="text-primary hover:underline">website</Link>.
        </p>
        ...
        <p>
          ...
          <Link to="/contact" className="text-primary hover:underline">contactformulier</Link> op aigeletterdheid.academy.
        </p>
